// Color
export const vino = '#621e21';
export const magenta = '#b0353b';
export const red = '#d64043';
export const pink = '#e9958d';
export const orange = '#f7c060';
...
// Typography
export const defaultTextColor = dark;
